...
public class TowerController : MonoBehaviour
{
    ...
    void Shoot()
    {
        ...
        firePoint.localPosition = new Vector2(targetX, targetY);
        ...
        //Add force to bullet
        bullet.GetComponent<Rigidbody2D>().AddForce(new Vector2(targetX, targetY) * tower.ammoForce, ForceMode2D.Impulse);
